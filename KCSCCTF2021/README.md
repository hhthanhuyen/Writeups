...
**Gợi ý:** Nhập một điểm R sao cho Q có bậc n nhỏ, khóa sẽ là một điểm thuộc nhóm sinh bới Q, \<Q\> = {0Q, 1Q, 2Q, ... , (n-1)Q}. Q có thể là điểm có góc là π/6, -π/4, π/3,... Như vậy phải đưa tọa độ của điểm Q về đường tròn trong **Z**<sub>p</sub>. Một điểm P(x,y) thuộc đường tròn này có điểm đối là -P = (-x,y). Điểm R cần nhập sẽ là R = Q - P.
